							...
							<div class="row">
								...
								<div class="col-sm-2">
									...
									<input type="number" id="num-pieces" required="true"
										...
										<?php echo esc_attr( shipsy_get_option( 'enable_multipiece_edit_option' ) === '1' ? 'readonly' : '' ); ?>
							...
							<div class="row">
								<div class="col-12">
									...
									<select class="custom-select " name="cod-collection-mode" required="true"
										...
										?>
										<?php if ('cod' === $curr_order->get_payment_method() && $total_cash_retrieval > 0) { ?>
											<option value="<?php echo esc_attr( 'cod' ); ?>"
						...
						<?php if ( $club_multi_pieces_into_single ) { ?>
							<div class="container piece-details-div" id="piece-det">
								...
								foreach ( $order_items as $key => $item ) {
									...
									$total_weight   += sanitize_text_field( $product->get_weight() ? $product->get_weight() : '1' );
								}
								// Add shipping charge
										...
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="number" required="true" name="weight[]" oninput="check(this)"
													step="any" min="0" class="form-control" value="<?php echo esc_html( $product->get_weight() ? $product->get_weight() : '1' ); ?>">
												<div class="peice-weight-error" style="color : red ; font-size : 10px;display:none">
													Weight is Required
												</div>
											</div>
