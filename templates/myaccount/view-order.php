...
if ( count( $synced_consignments ) > 0 ) : ?>
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		<thead>
			<tr>
				<th class="courier"><span class="nobr"><?php esc_html_e( 'Courier', 'zajel-shipping' ); ?></span></th>
				<th class="tracking-number"><span class="nobr"><?php esc_html_e( 'Waybill', 'zajel-shipping' ); ?></span></th>
				<th class="courier-status"><span class="nobr"><?php esc_html_e( 'Status', 'zajel-shipping' ); ?></span></th>
				<th class="tracking-url"><?php esc_html_e( 'Actions', 'zajel-shipping' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
			foreach ( $synced_consignments as $key => $tracking_item ) {
				?>
				<tr class="tracking">
					<td class="courier" data-title="<?php esc_attr_e( 'Courier', 'zajel-shipping' ); ?>">
						<?php echo esc_html( $ORGANISATION ); // phpcs:ignore ?>
					</td>
					<td class="tracking-number" data-title="<?php esc_attr_e( 'Waybill No', 'zajel-shipping' ); ?>">
						<?php echo esc_html( $tracking_item->shipsy_refno ); ?>
					</td>
					<td class="courier-status" data-title="<?php esc_attr_e( 'Courier Status', 'zajel-shipping' ); ?>">
						<?php
